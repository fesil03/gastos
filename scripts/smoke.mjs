...
const run = await page.$('[data-testid=declare-2024-06]')
check('P4 consecutive lapses collapse into one run (jun→jul 24)', run !== null && (await run.getAttribute('data-run-end')) === '2024-07')
...
check('P4 one-tap converts the run → declared', (await text('[data-testid=untracked-summary]')).includes('jun 24 → jul 24'))
check('P4 chart now has 6 gaps', (await page.$$('[data-testid=monthly-columns] svg line[stroke-dasharray="2 4"]')).length === 6)
...
check('P5 bundle separates untracked months', clip.includes('**untracked** months (2024-06, 2024-07, 2025-01, 2025-02, 2025-03, 2025-04)'), clip.split('\n').find((l) => l.startsWith('- Coverage')))
